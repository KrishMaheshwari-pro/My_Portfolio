...
const TechStackIcon = ({ TechStackIcon, Language }) => {
  return (
    <div className="tilt-card group p-6 rounded-2xl bg-slate-800/50 hover:bg-slate-700/50 transition-all duration-300 ease-in-out flex flex-col items-center justify-center gap-3 cursor-pointer shadow-lg hover:shadow-xl">
