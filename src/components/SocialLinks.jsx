...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/krish-maheshwari-2980a5319?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ekizr._",
    icon: Instagram,
    url: "https://www.instagram.com/krishmaheshwari07?igsh=MThrYWl1aGtsNXE4Nw==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@EkiZR",
    icon: Github,
    url: "https://github.com/KrishMaheshwari-pro",
    color: "#ffffff",
